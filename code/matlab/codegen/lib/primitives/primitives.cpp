                    ...
                    double *T2, double coeffsT1[6], double *v1, double *T1)
{
  ...
  if (a0 >= 0.0) {
    ...
    //     version 24.2. 06-Dec-2024 15:40:42
  ...
  if ((Tvmax != 0.0) && (Tvmax <= Tstar) && (*T1 <= *T2)) {
    ...
    *v2 = ((sf * -15.0 + c_v2_tmp * 7.0) + b_v2_tmp) * -0.125 / *T2;
    ...
    //     This function was generated by the Symbolic Math Toolbox
    //     version 24.2. 06-Dec-2024 15:40:41
    t3 = 0.0 * vfminStar;
    t4 = Tstar * 3.0;
    coeffsT1[0] = 0.0;
    coeffsT1[1] = v0;
                       ...
                       double *tfj0)
{
  ...
  *tfj0 = sf * 10.0 / (t2 - t9);
  ...
  t9 = a0 * t2;
  vfj0_tmp = rt_powd_snf(tfj0_list_idx_0, 3.0);
  b_vfj0_tmp = tfj0_list_idx_0 * v0;
  *vfj0 = ((((sf * -60.0 + b_vfj0_tmp * 36.0) + t9 * 9.0) - 0.0 * t2 * 3.0) +
           vfj0_tmp * 0.0) *
  ...
  if ((vfmin < *vfj0) && (vfmax > *vfj0)) {
    ...
    *tfj0 = tfj0_list_idx_0;
    ...
    coefsj0[3] =
        1.0 / vfj0_tmp *
        ((((sf * -20.0 + t4) - t3) + b_vfj0_tmp * 12.0) + coefsj0_tmp * 8.0) *
        -3.0;
    coefsj0[4] = 1.0 / (t2 * t2) *
                 ((((sf * -30.0 - t3 * 2.0) + t4) + b_vfj0_tmp * 16.0) +
                  coefsj0_tmp * 14.0) *
                 12.0;
    coefsj0[5] =
        1.0 / rt_powd_snf(tfj0_list_idx_0, 5.0) *
        ((((sf * -12.0 - t3) + b_vfj0_tmp * 6.0) + coefsj0_tmp * 6.0) + t9) *
        -60.0;
  } else {
    // FINAL_OPT_VEL_J0_PASS
    //     FINAL_OPT_VEL_J0_PASS_VAR = FINAL_OPT_VEL_J0_PASS(V0,A0,J0,SF,AF,T)
    //     This function was generated by the Symbolic Math Toolbox
    //     version 24.2. 06-Dec-2024 15:40:43
    t2 = *tfj0 * *tfj0;
    t9 = a0 * t2;
    vfj0_tmp = rt_powd_snf(*tfj0, 3.0);
    b_vfj0_tmp = *tfj0 * v0;
    *vfj0 = ((((sf * -60.0 + b_vfj0_tmp * 36.0) + t9 * 9.0) - 0.0 * t2 * 3.0) +
             vfj0_tmp * 0.0) *
                       ...
                       double *tfj0)
{
  ...
  if ((v0 > 0.0) && (a0 < 0.0)) {
    ...
    *tfj0 = v0 * -2.0 / a0;
    ...
    sfj0_tmp_tmp = a0 * t2_tmp;
    sfj0_tmp = sfj0_tmp_tmp * 3.0;
    b_sfj0_tmp = 1.0 / t3;
    b_sfj0_tmp_tmp = *tfj0 * v0;
    c_sfj0_tmp = b_sfj0_tmp_tmp * 12.0;
    d_sfj0_tmp = *tfj0 * 0.0 * 8.0;
    *sfj0 = t3 *
            (b_sfj0_tmp *
             (((c_sfj0_tmp + d_sfj0_tmp) + sfj0_tmp) - 0.0 * t2_tmp) * 3.0) /
            60.0;
    // COEF_LIST
    //     COEF_LIST_VAR = COEF_LIST(V0,A0,SF,VF,AF,T)
    //     This function was generated by the Symbolic Math Toolbox
    ...
    coefsj0[3] =
        b_sfj0_tmp *
        ((((*sfj0 * -20.0 + sfj0_tmp) - t3) + c_sfj0_tmp) + d_sfj0_tmp) * -3.0;
    coefsj0[4] =
        1.0 / (t2_tmp * t2_tmp) *
        ((((*sfj0 * -30.0 - t3 * 2.0) + sfj0_tmp) + b_sfj0_tmp_tmp * 16.0) +
         *tfj0 * 0.0 * 14.0) *
        12.0;
    coefsj0[5] =
        1.0 / rt_powd_snf(*tfj0, 5.0) *
        ((((*sfj0 * -12.0 - t3) + b_sfj0_tmp_tmp * 6.0) + *tfj0 * 0.0 * 6.0) +
         sfj0_tmp_tmp) *
        -60.0;
  } else {
    *sfj0 = 0.0;
